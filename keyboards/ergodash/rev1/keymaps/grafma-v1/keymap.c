...
#define ALTLFT LALT(KC_LFT)
#define VW_RGHT LCTL(LGUI(KC_RGHT))
#define VW_LFT LCTL(LGUI(KC_LFT))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL,          LOWER,   SFTSPC , SFTSPC,       SP1ENT , KC_BSPC ,RAISE,            KC_LGUI, KC_LFT,  KC_UP,   KC_RGHT  \
  ),
   ...
   */
  [_LOWER] = LAYOUT(
    KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   JU_LCBR,                        JU_RCBR, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F12,  \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL,          LOWER,   KC_SPC ,KC_DEL,         KC_DEL, KC_ENT , RAISE,            KC_HOME, KC_LFT,  KC_DOWN, KC_RGHT   \
  ),
