...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    JU_GRV,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    JU_SCLN, JU_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LCTL ,                       KC_DEL , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL,          LOWER,   KC_SPC ,KC_SPC,        KC_ENT , KC_BSPC ,RAISE,            KC_LGUI, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  /*
  [_QWERTY] = LAYOUT( \
  ...
  */
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TAB,  KC_LEFT, KC_DOWN, KC_RGHT, KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_H,    KC_4   , KC_5   , KC_6   , KC_COLN, KC_DQT , \
